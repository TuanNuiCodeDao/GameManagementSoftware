...
namespace GameManagementSoftware
{
    public class DataProvider
    {
        ...
        private static string path = @"C:\data_PhanMem_QL";
        private static string pathData = @"C:\data_PhanMem_QL\Infomation.txt";
        public static string dangThongKe = "Cũ";
        ...
        public bool loadInfo()
        {
            if (!Directory.Exists(path))
            {
                ...
                using (StreamWriter sw = new StreamWriter(pathData))
                {
                    sw.WriteLine("");
                    sw.WriteLine("");
                    sw.WriteLine("Cũ");
            ...
            try
            {
                using (StreamReader sr = new StreamReader(pathData))
                {
                    ...
                    S_DataProvider.database = sr.ReadLine();
                    dangThongKe= sr.ReadLine();
                }
                return true;
            }catch(Exception ex) { }
        ...
        public void saveInfo()
        {
            ...
            using (StreamWriter sw = new StreamWriter(pathData))
            {
                ...
                sw.WriteLine(S_DataProvider.database);
                sw.WriteLine(dangThongKe);
            }
        }
